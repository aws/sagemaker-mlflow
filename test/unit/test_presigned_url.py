...
class PresignedUrlTestsTrackingServer(TestCase):
    ...
    def test_presigned_url_with_assume_role(self, mock_session):
        ...
        mock_sts_client.assume_role.assert_called_once_with(
            RoleArn=TEST_VALID_ROLE_ARN, RoleSessionName="AuthBotoSagemakerMlFlow"
        )
...
@mock.patch.dict(
    os.environ,
    {"MLFLOW_TRACKING_URI": "arn:aws:sagemaker:us-west-2:000000000000:mlflow-app/xw"},
)
class PresignedUrlTestsMLflowApp(TestCase):
    ...
    def test_presigned_url(self, mock_session):
        ...
        mock_session.return_value.client.return_value = mock_client
        mock_response = {"AuthorizedUrl": TEST_VALID_URL}
        mock_client.create_presigned_mlflow_app_url.return_value = mock_response
        function_response = get_presigned_url()
        assert function_response == TEST_VALID_URL
    ...
    def test_presigned_url_with_fields(self, mock_session):
        ...
        create_presigned_api_request = {
            "Arn": "arn:aws:sagemaker:us-west-2:000000000000:mlflow-app/xw",
            "ExpiresInSeconds": 200,
            "SessionExpirationDurationInSeconds": 1800,
        }
        ...
        mock_client.create_presigned_mlflow_app_url.assert_called_with(**create_presigned_api_request)
